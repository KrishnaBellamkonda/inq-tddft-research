// ============================================================================
// save_gs/gs_L50_cubic_N162_dx1p0/run.cpp
//
...
using Cfg = jellium::config::Base_N162_L50_E1p5;
...
int main() {
    ...
    std::cout << "\n=== save_gs/gs_L50_cubic_N162_dx1p0 ===\n"
    ...
    if (electrons.root()) {
        ...
        summary << "run = save_gs/gs_L50_cubic_N162_dx1p0\n"
                << "system = jellium_N162_L50_closed_shell_E1p5_wide_WP\n"
