// ============================================================================
// save_gs/gs_L30_cubic_N138_dx0p85/run.cpp
//
// Jellium GS at cell = 30^3 Bohr cubic-periodic, N = 138 (closed-shell magic
// |G|^2 <= 6 — same shell as the L=60 run, smaller box).
// Density 5.11e-3 e/bohr^3, r_s ~= 3.61 bohr (sodium-like, metallic).
// Spacing 0.85 bohr (k_Nyquist = 3.696 Bohr^-1; resolves WP up to
// k_0 + 3 sigma_k = 0.606 + 2.996 = 3.602 Bohr^-1 with margin).
// EXTRA_STATES = 20 to populate ~2 unoccupied shells (|G|^2=8 and 9)
// above Fermi smearing for clean e-h transition diagnostics.
//
// Cfg = jellium::config::Base_N138_L30_E5 (the new project base).
// ============================================================================
#include <inq/inq.hpp>
...
using Cfg = jellium::config::Base_N138_L30_E5;
...
int main() {
    ...
    std::cout << "\n=== save_gs/gs_L30_cubic_N138_dx0p85 ===\n"
    ...
    if (electrons.root()) {
        ...
        summary << "run = save_gs/gs_L30_cubic_N138_dx0p85\n"
                << "system = jellium_N138_L30_closed_shell_E5_lowE_WP\n"
