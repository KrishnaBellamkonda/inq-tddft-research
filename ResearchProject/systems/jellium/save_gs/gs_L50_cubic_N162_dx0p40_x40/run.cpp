// ============================================================================
// save_gs/gs_L50_cubic_N162_dx0p40/run.cpp  (v2 of the comparison plan)
//
...
// Classical-only Cfg with dx=0.40 (vs the WP/standard dx=0.30).
using Cfg = jellium::config::Electron_Proj_E100_L50_cubic_WP_dx0p40_x40;
...
int main() {
    ...
    const std::string CHECKPOINT_DIR =
        ...
        "checkpoints/gs_L50_cubic_N162_dx0p40_x40";

    std::cout << "\n=== save_gs/gs_L50_cubic_N162_dx0p40_x40 ===\n"
    ...
    if (electrons.root()) {
        ...
        summary << "run = save_gs/gs_L50_cubic_N162_dx0p40\n"
