// ============================================================================
// run_classical_n162_L50_E900_knudsen/run.cpp — classical-electron projectile (custom
...
//
// Cfg: jellium::config::KnudsenSweep_L50_cubic_Classical_E900.
...
using Cfg = jellium::config::KnudsenSweep_L50_cubic_Classical_E900;
...
int main() {
    ...
    const std::string RUN_NAME = "run_classical_n162_L50_E900_knudsen";
