// ============================================================================
// run_wp_n162_L50_E600/run.cpp — Gaussian wave-packet projectile in a cubic
// 50^3 Bohr periodic jellium bath at N=162, dx=0.40, E_kin=100 eV.
//
// Companion of run_classical_n162_L50_E100/.
//
// Cfg: jellium::config::Electron_Proj_E600_L50_cubic_WP_dx0p40.
...
using Cfg = jellium::config::Electron_Proj_E600_L50_cubic_WP_dx0p40;
...
int main() {
    ...
    const std::string RUN_NAME = "run_wp_n162_L50_E600";
