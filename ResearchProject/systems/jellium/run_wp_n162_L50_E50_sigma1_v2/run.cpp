// ============================================================================
// run_wp_n162_L50_E50_sigma1_v2/run.cpp — v2 rerun of σ=1 WP at E=50 eV
// in the standard-density L=50 bath. dt=0.01, WP density+wavefunction saving.
//
// Cfg: jellium::config::Electron_Proj_E50_L50_sigma1_v2_WP.
...
using Cfg = jellium::config::Electron_Proj_E50_L50_sigma1_v2_WP;
...
int main() {
    ...
    const std::string RUN_NAME = "run_wp_n162_L50_E50_sigma1_v2";
