// ============================================================================
// run_wp_n162_L30_E100_highdens_sigma1/run.cpp — Gaussian wave-packet projectile in a cubic
...
//
// Cfg: jellium::config::HighDens_N162_L30_E100_sigma1_WP_dx0p40.
...
#include "../shared/configs/highdens_n162_L30_E100_sigma1.hpp"
...
using Cfg = jellium::config::HighDens_N162_L30_E100_sigma1_WP_dx0p40;
...
int main() {
    ...
    const std::string RUN_NAME = "run_wp_n162_L30_E100_highdens_sigma1";
