// ============================================================================
// run_classical_n162_L30_E50_highdens_v2/run.cpp — classical-electron projectile (custom
// UPF + mass override = m_e) through the cubic 30^3 Bohr periodic jellium
// bath at N=162, dx=0.40, E_kin=50 eV. v2: dt=0.01 a.u.
//
// Cfg: jellium::config::HighDens_N162_L30_E50_sigma1_v2_Classical.
...
#include "../shared/configs/highdens_n162_L30_E50_sigma1_v2.hpp"
...
using Cfg = jellium::config::HighDens_N162_L30_E50_sigma1_v2_Classical;
...
int main() {
    ...
    const std::string RUN_NAME = "run_classical_n162_L30_E50_highdens_v2";
