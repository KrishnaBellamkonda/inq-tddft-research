...
CFG = dict(
    LX=46.0, LY=46.0, LZ=80.0, N_E=218, DX=0.40,
    SIGMA_WP=2.0, EKIN_EV=100.0, K0=2.7111, Z0=-32.0,
    DT=0.04, N_STEPS=646,
    FIT_T0=4.0, FIT_T1=18.9719,
    T_IFW=18.9719, T_TRANSVERSE=21.3125,
...
def build(half: str) -> nbf.NotebookNode:
    is_wp = half == "wp"
    run_dir = SYSTEM / "scripts/bulk_ks_stopping" / half
...
def main() -> int:
    ...
    half = sys.argv[1]
    nb = build(half)
    out = HERE / f"bulk_ks_stopping_{half}.ipynb"
