...
CFG = dict(
    ...
    FIT_T0=4.0, FIT_T1=10.7961,
    T_IFW=15.7133, T_TRANSVERSE=10.7961, COMMON_FIT_T1=9.37,
...
def build(half: str) -> nbf.NotebookNode:
    is_wp = half == "wp"
    run_dir = SYSTEM / "scripts/bulk_ks_stopping_sigma1" / half
...
def main() -> int:
    ...
    half = sys.argv[1]
    nb = build(half)
    out = HERE / f"bulk_ks_stopping_sigma1_{half}.ipynb"
