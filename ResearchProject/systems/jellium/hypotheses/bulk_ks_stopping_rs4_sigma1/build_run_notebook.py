...
CFG = dict(
    ...
    SIGMA_WP=1.0, EKIN_EV=100.0, K0=2.7111, Z0=-36.0,
    DT=0.04, N_STEPS=692,
    ...
    FIT_T0=4.0, FIT_T1=9.3749,
    T_IFW=15.7133, T_TRANSVERSE=9.3749, COMMON_FIT_T1=9.37,
...
def build(half: str) -> nbf.NotebookNode:
    is_wp = half == "wp"
    run_dir = SYSTEM / "scripts/bulk_ks_stopping_rs4_sigma1" / half
...
def main() -> int:
    ...
    half = sys.argv[1]
    nb = build(half)
    out = HERE / f"bulk_ks_stopping_rs4_sigma1_{half}.ipynb"
