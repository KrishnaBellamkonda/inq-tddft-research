// ============================================================================
// run_classical_n162_L30_E300_highdens/run.cpp — classical-electron projectile (custom
// UPF + mass override = m_e) through the cubic 30^3 Bohr periodic jellium
// bath at N=162, dx=0.40, E_kin=300 eV.
//
// Companion of run_wp_n162_L30_E300_highdens/.
//
// Cfg: jellium::config::HighDens_N162_L30_E300_sigma1_Classical_dx0p40.
//
// GS: reuses checkpoints/gs_L30_cubic_N162_dx0p40 (no new GS needed; same
// grid as the E=100 classical run).
// ============================================================================
...
#include "../shared/configs/highdens_n162_L30_E300_sigma1.hpp"
...
using Cfg = jellium::config::HighDens_N162_L30_E300_sigma1_Classical_dx0p40;
...
int main() {
    ...
    const std::string RUN_NAME = "run_classical_n162_L30_E300_highdens";
