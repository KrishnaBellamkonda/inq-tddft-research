// ============================================================================
// run_classical_n162_L50_E100_v2/run.cpp — classical-electron projectile (custom
// UPF + mass override = m_e) through the cubic 50^3 Bohr periodic jellium
// bath at N=162, dx=0.40, E_kin=100 eV. v2: dt=0.01 a.u.
//
// Cfg: jellium::config::Electron_Proj_E100_L50_sigma1_v2_Classical.
...
using Cfg = jellium::config::Electron_Proj_E100_L50_sigma1_v2_Classical;
...
int main() {
    ...
    const std::string RUN_NAME = "run_classical_n162_L50_E100_v2";
