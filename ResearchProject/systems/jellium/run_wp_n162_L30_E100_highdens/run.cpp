// ============================================================================
// run_wp_n162_L30_E100_highdens/run.cpp — Gaussian wave-packet projectile in a cubic
// 30^3 Bohr periodic jellium bath at N=162, dx=0.40, E_kin=100 eV.
//
// Run-6 (WP half) of the 2026-05-21 Emilio meeting campaign — fastest path to an
...
//
// Cfg: jellium::config::HighDens_N162_L30_E100_WP_dx0p40.
...
using Cfg = jellium::config::HighDens_N162_L30_E100_WP_dx0p40;
...
int main() {
    ...
    const std::string RUN_NAME = "run_wp_n162_L30_E100_highdens";
