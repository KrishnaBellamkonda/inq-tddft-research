// ============================================================================
// run_base_n162_L50_E1p5 - L=50 jellium with low-energy, wide WP.
...
//
// N=162 closed shell |G|^2<=6, dx=1.0 bohr, sigma=5.0 bohr, E_WP=1.5 eV,
// 1500 steps at dt=0.020 -> t_final = 30.0 a.u. (= 0.726 fs).
//
// Cfg = jellium::config::Base_N162_L50_E1p5.
// GS loaded from save_gs/gs_L50_cubic_N162_dx1p0.
// ============================================================================

#include "../shared/configs/base_n162_L50_E1p5.hpp"
#include "../shared/cpp/run_template.hpp"

int main() {
    return jellium::run_template::run_propagation<jellium::config::Base_N162_L50_E1p5>(
