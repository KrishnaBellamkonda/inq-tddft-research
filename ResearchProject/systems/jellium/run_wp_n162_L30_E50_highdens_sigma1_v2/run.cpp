// ============================================================================
// run_wp_n162_L30_E50_highdens_sigma1_v2/run.cpp — v2 rerun of σ=1 WP at E=50 eV
// in the high-density L=30 bath. dt=0.01, WP density+wavefunction saving.
//
// Cfg: jellium::config::HighDens_N162_L30_E50_sigma1_v2_WP.
...
using Cfg = jellium::config::HighDens_N162_L30_E50_sigma1_v2_WP;
...
int main() {
    ...
    const std::string RUN_NAME = "run_wp_n162_L30_E50_highdens_sigma1_v2";
