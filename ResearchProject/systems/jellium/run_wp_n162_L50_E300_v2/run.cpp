// ============================================================================
// run_wp_n162_L50_E300_v2/run.cpp — Gaussian wave-packet projectile in a cubic
...
//
// Cfg: jellium::config::Backlog_L50_cubic_WP_E300.
...
using Cfg = jellium::config::Backlog_L50_cubic_WP_E300;
...
int main() {
    ...
    const std::string RUN_NAME = "run_wp_n162_L50_E300_v2";
