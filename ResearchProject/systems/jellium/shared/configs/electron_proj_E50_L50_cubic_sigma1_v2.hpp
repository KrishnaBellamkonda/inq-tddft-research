// ============================================================================
// electron_proj_E50_L50_cubic_sigma1_v2.hpp — v2 rerun with:
...
//
// Self-spread bound (σ=1, L=50, v=1.916):
//   -21 + 1.916·t + 2.121·√(1+t²) = 25  →  t* ≈ 11.4 a.u.
//   N_STEPS = 1140 at dt=0.01.
//
...
struct Common_E50_L50_sigma1_v2 : Base_N162_L50_E1p5 {
...
struct Electron_Proj_E50_L50_sigma1_v2_WP : Common_E50_L50_sigma1_v2 {
    static constexpr bool WP_ENABLED = true;
    static constexpr int  N_IONS     = 0;
};

struct Electron_Proj_E50_L50_sigma1_v2_Classical : Common_E50_L50_sigma1_v2 {
    static constexpr bool WP_ENABLED = false;
    static constexpr int  N_IONS     = 1;
    // Boundary-rule N_STEPS: traversal=45 / (v=1.916 * dt=0.01) → 2349
    static constexpr int N_STEPS     = 2349;
    static constexpr int WRITE_EVERY = 8;              // ~294 density frames
};
