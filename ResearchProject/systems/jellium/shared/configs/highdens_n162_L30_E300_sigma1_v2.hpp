// ============================================================================
// highdens_n162_L30_E300_sigma1_v2.hpp — v2 rerun with:
...
//
// Self-spread bound (σ=1, L=30, v=4.696):
//   -11 + 4.696·t + 2.121·√(1+t²) = 15  →  t* ≈ 3.8 a.u.
//   N_STEPS = 380 at dt=0.01.
//
...
struct Common_HighDens_N162_L30_E300_sigma1_v2 : Base_N162_L50_E1p5 {
    ...
    // Self-spread-capped: t* ≈ 3.8 a.u. at dt=0.01 → 380 steps
    static constexpr int N_STEPS     = 380;
    static constexpr int WRITE_EVERY = 1;              // ~380 density frames

    // WP wavefunction saving cadence (heavier I/O — less frequent)
    static constexpr int WF_WRITE_EVERY = 10;          // ~38 wavefunction frames
...
struct HighDens_N162_L30_E300_sigma1_v2_WP : Common_HighDens_N162_L30_E300_sigma1_v2 {
    static constexpr bool WP_ENABLED = true;
    static constexpr int  N_IONS     = 0;
};

struct HighDens_N162_L30_E300_sigma1_v2_Classical : Common_HighDens_N162_L30_E300_sigma1_v2 {
    static constexpr bool WP_ENABLED = false;
    static constexpr int  N_IONS     = 1;
    // Boundary-rule N_STEPS: traversal=25 / (v=4.696 * dt=0.01) → 533
    static constexpr int N_STEPS     = 533;
    static constexpr int WRITE_EVERY = 2;              // ~267 density frames
};
