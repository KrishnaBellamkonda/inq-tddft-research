// ============================================================================
// highdens_n162_L30_E50_sigma1_v2.hpp — v2 rerun with:
...
//   -11 + 1.916·t + 2.121·√(1+t²) = 15  →  t* ≈ 6.4 a.u.
//   N_STEPS = 640 at dt=0.01.
//
...
struct Common_HighDens_N162_L30_E50_sigma1_v2 : Base_N162_L50_E1p5 {
    ...
    // Self-spread-capped: t* ≈ 6.4 a.u. at dt=0.01 → 640 steps
    static constexpr int N_STEPS     = 640;
    static constexpr int WRITE_EVERY = 2;              // ~320 density frames

    // WP wavefunction saving cadence (heavier I/O — less frequent)
    static constexpr int WF_WRITE_EVERY = 10;          // ~64 wavefunction frames
...
struct HighDens_N162_L30_E50_sigma1_v2_WP : Common_HighDens_N162_L30_E50_sigma1_v2 {
    static constexpr bool WP_ENABLED = true;
    static constexpr int  N_IONS     = 0;
};

struct HighDens_N162_L30_E50_sigma1_v2_Classical : Common_HighDens_N162_L30_E50_sigma1_v2 {
    static constexpr bool WP_ENABLED = false;
    static constexpr int  N_IONS     = 1;
    // Boundary-rule N_STEPS: traversal=25 / (v=1.916 * dt=0.01) → 1305
    static constexpr int N_STEPS     = 1305;
    static constexpr int WRITE_EVERY = 4;              // ~326 density frames
};
