// ============================================================================
// highdens_n162_L30_E100_sigma1_v2.hpp — v2 rerun with:
...
//
// Self-spread bound (σ=1, L=30, v=2.711):
//   -11 + 2.711·t + 2.121·√(1+t²) = 15  →  t* ≈ 5.35 a.u.
//   N_STEPS = 535 at dt=0.01.
//
// Nyquist: k₀=2.711, σ_k=0.707. k_max=4.83. k_Nyq=7.85. Ratio 0.62 — OK.
...
struct Common_HighDens_N162_L30_E100_sigma1_v2 : Base_N162_L50_E1p5 {
    ...
    static constexpr double WP_K0           = k0_from_ev(WP_EKIN_EV); // 2.711
    ...
    // Self-spread-capped: t* ≈ 5.35 a.u. at dt=0.01 → 535 steps
    static constexpr int N_STEPS     = 535;
    static constexpr int WRITE_EVERY = 2;              // ~268 density frames

    // WP wavefunction saving cadence (heavier I/O — less frequent)
    static constexpr int WF_WRITE_EVERY = 10;          // ~54 wavefunction frames
...
struct HighDens_N162_L30_E100_sigma1_v2_WP : Common_HighDens_N162_L30_E100_sigma1_v2 {
    static constexpr bool WP_ENABLED = true;
    static constexpr int  N_IONS     = 0;
};

struct HighDens_N162_L30_E100_sigma1_v2_Classical : Common_HighDens_N162_L30_E100_sigma1_v2 {
    static constexpr bool WP_ENABLED = false;
    static constexpr int  N_IONS     = 1;
    // Boundary-rule N_STEPS: traversal=25 / (v=2.711 * dt=0.01) → 922
    static constexpr int N_STEPS     = 922;
    static constexpr int WRITE_EVERY = 3;              // ~307 density frames
};
