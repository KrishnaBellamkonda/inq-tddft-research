// ============================================================================
// electron_proj_E200_L50_cubic_sigma1_v2.hpp — v2 rerun with:
...
//
// Self-spread bound (σ=1, L=50, v=3.834):
//   -21 + 3.834·t + 2.121·√(1+t²) = 25  →  t* ≈ 8.0 a.u.
//   N_STEPS = 800 at dt=0.01.
//
...
struct Common_E200_L50_sigma1_v2 : Base_N162_L50_E1p5 {
    ...
    // Self-spread-capped: t* ≈ 8.0 a.u. at dt=0.01 → 800 steps
    static constexpr int N_STEPS     = 800;
    static constexpr int WRITE_EVERY = 3;              // ~267 density frames

    // WP wavefunction saving cadence (heavier I/O — less frequent)
    static constexpr int WF_WRITE_EVERY = 10;          // ~80 wavefunction frames
...
struct Electron_Proj_E200_L50_sigma1_v2_WP : Common_E200_L50_sigma1_v2 {
    static constexpr bool WP_ENABLED = true;
    static constexpr int  N_IONS     = 0;
};

struct Electron_Proj_E200_L50_sigma1_v2_Classical : Common_E200_L50_sigma1_v2 {
    static constexpr bool WP_ENABLED = false;
    static constexpr int  N_IONS     = 1;
    // Boundary-rule N_STEPS: traversal=45 / (v=3.834 * dt=0.01) → 1174
    static constexpr int N_STEPS     = 1174;
    static constexpr int WRITE_EVERY = 4;              // ~294 density frames
};
