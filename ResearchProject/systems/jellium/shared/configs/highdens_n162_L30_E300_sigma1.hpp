// ============================================================================
// shared/configs/highdens_n162_L30_E300_sigma1.hpp — σ=1 high-density run at
// E=300 eV (L=30, r_s≈3.41). Part of the density-dependence σ=1 sweep.
//
// SELF-SPREAD BOUND (σ=1, L=30, v=4.696):
//   -11 + 4.696·t + 2.121·√(1+t²) = 15  →  t* ≈ 3.8 a.u.  →  N_STEPS = 190.
//
// Nyquist: k₀=4.696, σ_k=0.707. k_max=6.82. k_Nyq=7.85. Ratio 0.87 —
// marginal but within limits (3σ_k criterion is conservative: Gaussian
// tails are exponentially suppressed beyond 3σ).
//
...
struct Common_HighDens_N162_L30_E300_sigma1 : Base_N162_L50_E1p5 {
    ...
    static constexpr int N_STEPS     = 190;
    static constexpr int WRITE_EVERY = 2;              // 95 frames
...
struct HighDens_N162_L30_E300_sigma1_WP_dx0p40 : Common_HighDens_N162_L30_E300_sigma1 {
    static constexpr bool WP_ENABLED = true;
    static constexpr int  N_IONS     = 0;
};

struct HighDens_N162_L30_E300_sigma1_Classical_dx0p40 : Common_HighDens_N162_L30_E300_sigma1 {
