// ============================================================================
// run_wp_n162_L50_E300/run.cpp — Gaussian wave-packet projectile in a cubic
// 50^3 Bohr periodic jellium bath at N=162, dx=0.40, E_kin=100 eV.
//
// Companion of run_classical_n162_L50_E100/.
//
// Cfg: jellium::config::Electron_Proj_E300_L50_cubic_WP_dx0p40.
// WP is a Gaussian at (0, 0, -10) Bohr (IDENTICAL launch to E=1500 pair
// and the classical sibling), k_0=2.7111 bohr^-1 in +z, sigma_r=5.0 Bohr,
// KE=100 eV.
//
...
using Cfg = jellium::config::Electron_Proj_E300_L50_cubic_WP_dx0p40;
...
int main() {
    ...
    const std::string RUN_NAME = "run_wp_n162_L50_E300";
