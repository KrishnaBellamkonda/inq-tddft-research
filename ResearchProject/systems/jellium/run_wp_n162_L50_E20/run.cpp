// ============================================================================
// run_wp_n162_L50_E20/run.cpp — Gaussian wave-packet projectile in a cubic
...
//
// Cfg: jellium::config::Electron_Proj_E20_L50_cubic_WP_dx0p40.
...
using Cfg = jellium::config::Electron_Proj_E20_L50_cubic_WP_dx0p40;
...
int main() {
    ...
    const std::string RUN_NAME = "run_wp_n162_L50_E20";
