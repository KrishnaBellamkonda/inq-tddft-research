// ============================================================================
// run_wp_n162_L50_E25/run.cpp — Gaussian wave-packet projectile in a cubic
// 50^3 Bohr periodic jellium bath at N=162, dx=0.40, E_kin=25 eV.
//
// Run-1 of the 2026-05-21 Emilio meeting campaign — fastest path to an
...
//
// Cfg: jellium::config::Electron_Proj_E25_L50_cubic_WP_dx0p40.
// WP is a Gaussian at launch_z = -L/2 + 4σ = -5 Bohr (updated 2026-05-17
// to the universal boundary rule), k_0=1.356 bohr^-1 in +z, sigma_r=5.0
// Bohr, KE=25 eV. N_STEPS=922, WRITE_EVERY=3 (~307 frames).
//
...
using Cfg = jellium::config::Electron_Proj_E25_L50_cubic_WP_dx0p40;
...
int main() {
    ...
    const std::string RUN_NAME = "run_wp_n162_L50_E25";
