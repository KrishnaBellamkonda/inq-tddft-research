// ============================================================================
// run_classical_n162_L50_E100_sigma1/run.cpp — classical-electron projectile (custom
// UPF + mass override = m_e) through the cubic 50^3 Bohr periodic jellium
// bath at N=162, dx=0.40, E_kin=100 eV.
//
// Companion of run_wp_n162_L50_E100/.
//
// Cfg: jellium::config::Electron_Proj_E100_L50_sigma1_Classical_dx0p40.
// Velocity match with WP is automatic: KE=100 eV (= 3.6749 Ha), m=1 a.u.
// (= m_e via mass override) ⇒ v_z = sqrt(2 * 3.6749) = 2.7111 bohr/atu,
// identical to WP_K0.
//
// PHYSICS: v=2.71 sits between v_F=0.55 (Lindhard peak) and v=10.5 (Bethe).
// Same bath/geometry/launch as the E=1500 sibling pair → projectile-kind
// effect is the only variable across this comparison.
//
// GS: reuses checkpoints/gs_L50_cubic_N162_dx0p40 (no new GS needed; same
// grid as the E=1500 classical run).
// ============================================================================
...
#include "../shared/configs/electron_proj_E100_L50_cubic_sigma1.hpp"
...
using Cfg = jellium::config::Electron_Proj_E100_L50_sigma1_Classical_dx0p40;
...
int main() {
    ...
    const std::string RUN_NAME = "run_classical_n162_L50_E100_sigma1";
