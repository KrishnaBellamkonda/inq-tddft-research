// ============================================================================
// run_wp_n162_L30_E300_highdens_sigma1/run.cpp — Gaussian wave-packet projectile
// in a cubic 30^3 Bohr periodic jellium bath at N=162, dx=0.40, E_kin=300 eV.
//
// Cfg: jellium::config::HighDens_N162_L30_E300_sigma1_WP_dx0p40.
// ============================================================================
...
using Cfg = jellium::config::HighDens_N162_L30_E300_sigma1_WP_dx0p40;
...
int main() {
    ...
    const std::string RUN_NAME = "run_wp_n162_L30_E300_highdens_sigma1";
