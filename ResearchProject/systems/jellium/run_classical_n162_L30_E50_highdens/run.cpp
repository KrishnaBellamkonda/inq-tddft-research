// ============================================================================
// run_classical_n162_L30_E50_highdens/run.cpp — classical-electron projectile (custom
// UPF + mass override = m_e) through the cubic 30^3 Bohr periodic jellium
// bath at N=162, dx=0.40, E_kin=50 eV.
//
// Companion of run_wp_n162_L30_E50_highdens/.
//
// Cfg: jellium::config::HighDens_N162_L30_E50_sigma1_Classical_dx0p40.
//
...
#include "../shared/configs/highdens_n162_L30_E50_sigma1.hpp"
...
using Cfg = jellium::config::HighDens_N162_L30_E50_sigma1_Classical_dx0p40;
...
int main() {
    ...
    const std::string RUN_NAME = "run_classical_n162_L30_E50_highdens";
