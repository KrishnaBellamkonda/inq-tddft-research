// ============================================================================
// run_classical_n162_L50_E100/run.cpp — classical-electron projectile (custom
...
//
// Cfg: jellium::config::Electron_Proj_E100_L50_cubic_Classical_dx0p40.
...
using Cfg = jellium::config::Electron_Proj_E100_L50_cubic_Classical_dx0p40;
...
int main() {
    ...
    const std::string RUN_NAME = "run_classical_n162_L50_E100";
