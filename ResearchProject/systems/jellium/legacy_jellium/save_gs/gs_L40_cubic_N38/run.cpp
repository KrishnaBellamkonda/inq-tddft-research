...
//
// Jellium GS at cell = 40^3 Bohr cubic-periodic, N = 38 closed-shell.
// Loaded by run_base, run_E50_s0p53, run_E400_s0p53, run_E200_s0p53_tilt45,
// run_E200_s2p0, run_E200_s0p265 (all variants that share this cell + N).
// ============================================================================
#include <inq/inq.hpp>
...
int main() {
    ...
    if (electrons.root()) {
        ...
        summary << "run = save_gs/gs_L40_cubic_N38\n"
                << "system = jellium_N38_closed_shell\n"
