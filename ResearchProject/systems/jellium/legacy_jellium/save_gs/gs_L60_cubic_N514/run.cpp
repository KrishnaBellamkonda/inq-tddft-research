// ============================================================================
// save_gs/gs_L60_cubic_N514/run.cpp
//
// Jellium GS at cell = 60^3 Bohr cubic-periodic, N = 514 (closed-shell
// magic |G|^2 <= 16). Density 2.380e-3 e/bohr^3 is 4.015x the legacy Base
// density; r_s ~= 4.64 bohr (sodium/potassium regime).
//
// Cfg = jellium::config::Base_HighN (defined in shared/configs/base_highN.hpp).
// All Cfg fields except N_ELECTRONS, EXTRA_STATES, and SCF_TOL_HA are
// inherited from Base.
// ============================================================================
#include <inq/inq.hpp>
...
using Cfg = jellium::config::Base_HighN;
...
int main() {
    ...
    std::cout << "\n=== save_gs/gs_L60_cubic_N514 ===\n"
              << "  cell = " << Cfg::L_BOHR << "^3 Bohr (cubic, periodic)\n"
              << "  N_electrons = " << Cfg::N_ELECTRONS << " (closed shell |G|^2 <= 16)\n"
    ...
    if (electrons.root()) {
        ...
        summary << "run = save_gs/gs_L60_cubic_N514\n"
                << "system = jellium_N514_closed_shell_4x_density\n"
