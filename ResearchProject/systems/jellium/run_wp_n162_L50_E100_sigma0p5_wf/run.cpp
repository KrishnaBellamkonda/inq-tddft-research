// ============================================================================
// run_wp_n162_L50_E100_sigma0p5_wf/run.cpp — σ=0.5 WP at E=100 eV, L=50 bath.
...
//
// Cfg: jellium::config::Electron_Proj_E100_L50_sigma0p5_WP_dx0p40 (WF_WRITE_EVERY
...
using Cfg = jellium::config::Electron_Proj_E100_L50_sigma0p5_WP_dx0p40;
...
int main() {
    ...
    const std::string RUN_NAME = "run_wp_n162_L50_E100_sigma0p5_wf";
