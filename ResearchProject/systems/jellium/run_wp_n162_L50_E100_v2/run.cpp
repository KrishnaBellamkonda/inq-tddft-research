// ============================================================================
// run_wp_n162_L50_E100_v2/run.cpp — Gaussian wave-packet projectile in a cubic
...
//
// Cfg: jellium::config::Electron_Proj_E100_L50_cubic_WP_dx0p40_v2.
...
using Cfg = jellium::config::Electron_Proj_E100_L50_cubic_WP_dx0p40_v2;
...
int main() {
    ...
    const std::string RUN_NAME = "run_wp_n162_L50_E100_v2";
