// ============================================================================
// run_wp_n162_L50_E25_sigma1/run.cpp — Gaussian wave-packet projectile in a cubic
...
//
// Cfg: jellium::config::Electron_Proj_E25_L50_sigma1_WP_dx0p40.
...
#include "../shared/configs/electron_proj_E25_L50_cubic_sigma1.hpp"
...
using Cfg = jellium::config::Electron_Proj_E25_L50_sigma1_WP_dx0p40;
...
int main() {
    ...
    const std::string RUN_NAME = "run_wp_n162_L50_E25_sigma1";
