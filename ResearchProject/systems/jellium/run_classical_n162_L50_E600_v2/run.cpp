// ============================================================================
// run_classical_n162_L50_E600_v2/run.cpp — classical-electron projectile (custom
...
//
// Cfg: jellium::config::Backlog_L50_cubic_Classical_E600.
...
using Cfg = jellium::config::Backlog_L50_cubic_Classical_E600;
...
int main() {
    ...
    const std::string RUN_NAME = "run_classical_n162_L50_E600_v2";
