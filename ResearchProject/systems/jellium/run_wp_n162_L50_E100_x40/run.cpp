// ============================================================================
// run_wp_n162_L50_E100_x40/run.cpp — Gaussian wave-packet projectile in a cubic
...
//
// Cfg: jellium::config::Electron_Proj_E100_L50_cubic_WP_dx0p40_x40.
...
int main() {
    ...
    const std::string RUN_NAME = "run_wp_n162_L50_E100_x40";
