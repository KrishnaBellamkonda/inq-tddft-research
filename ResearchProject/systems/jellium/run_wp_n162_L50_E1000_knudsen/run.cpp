// ============================================================================
// run_wp_n162_L50_E1000_knudsen/run.cpp — Gaussian wave-packet projectile in a cubic
...
//
// Cfg: jellium::config::KnudsenSweep_L50_cubic_WP_E1000.
...
using Cfg = jellium::config::KnudsenSweep_L50_cubic_WP_E1000;
...
int main() {
    ...
    const std::string RUN_NAME = "run_wp_n162_L50_E1000_knudsen";
