...
#include "../../../shared/configs/bulk_ks_stopping_L40x40x80_rs4_sigma3.hpp"
...
using Cfg = jellium::config::Bulk_KS_L40x40x80_rs4_sigma3_WP;
...
int main() {
    ...
    const std::string RUN_NAME = "bulk_ks_stopping_rs4_sigma3_wp";
