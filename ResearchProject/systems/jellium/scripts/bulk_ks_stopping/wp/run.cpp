...
#include "../../../shared/configs/bulk_ks_stopping_L46x46x80.hpp"
...
using Cfg = jellium::config::Bulk_KS_Stopping_L46x46x80_WP;
...
int main() {
    ...
    const std::string RUN_NAME = "bulk_ks_stopping_wp";
