...
#include "../../../shared/configs/bulk_ks_stopping_L46x46x80_sigma3.hpp"
...
using Cfg = jellium::config::Bulk_KS_L46x46x80_sigma3_WP;
...
int main() {
    ...
    const std::string RUN_NAME = "bulk_ks_stopping_sigma3_wp";
    ...
    //
    // CLOSURE, gated below: E_SS + E_PS + E_PP == INQ energy_hartree.
