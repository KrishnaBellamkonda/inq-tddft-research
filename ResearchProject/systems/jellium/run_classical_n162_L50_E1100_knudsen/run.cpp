// ============================================================================
// run_classical_n162_L50_E1100_knudsen/run.cpp — classical-electron projectile (custom
...
//
// Cfg: jellium::config::KnudsenSweep_L50_cubic_Classical_E1100.
...
//
// GS: reuses checkpoints/gs_L50_cubic_N162_dx0p30 (no new GS needed; same
...
using Cfg = jellium::config::KnudsenSweep_L50_cubic_Classical_E1100;
...
int main() {
    ...
    const std::string RUN_NAME = "run_classical_n162_L50_E1100_knudsen";
