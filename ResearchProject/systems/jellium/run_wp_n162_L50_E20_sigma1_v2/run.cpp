// ============================================================================
// run_wp_n162_L50_E20_sigma1_v2/run.cpp — v2 rerun of σ=1 WP at E=20 eV
// in the standard-density L=50 bath. dt=0.01, WP density+wavefunction saving.
//
// Cfg: jellium::config::Electron_Proj_E20_L50_sigma1_v2_WP.
...
#include "../shared/configs/electron_proj_E20_L50_cubic_sigma1_v2.hpp"
...
using Cfg = jellium::config::Electron_Proj_E20_L50_sigma1_v2_WP;
...
int main() {
    ...
    const std::string RUN_NAME = "run_wp_n162_L50_E20_sigma1_v2";
