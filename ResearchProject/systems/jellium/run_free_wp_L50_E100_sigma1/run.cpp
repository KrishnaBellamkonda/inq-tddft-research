// ============================================================================
// run_free_wp_L50_E100_sigma1/run.cpp — σ=1 companion of the 2026-05-21 meeting campaign.
//
...
int main() {
    ...
    const std::string RUN_NAME = "run_free_wp_L50_E100_sigma1";
