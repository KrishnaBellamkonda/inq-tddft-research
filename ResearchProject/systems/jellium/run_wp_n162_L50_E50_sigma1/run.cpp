// ============================================================================
// run_wp_n162_L50_E50_sigma1/run.cpp — Gaussian wave-packet projectile in a cubic
// 50^3 Bohr periodic jellium bath at N=162, dx=0.40, E_kin=50 eV.
//
// Cfg: jellium::config::Electron_Proj_E50_L50_sigma1_WP_dx0p40.
// ============================================================================
...
#include "../shared/configs/electron_proj_E50_L50_cubic_sigma1.hpp"
...
using Cfg = jellium::config::Electron_Proj_E50_L50_sigma1_WP_dx0p40;
...
int main() {
    ...
    const std::string RUN_NAME = "run_wp_n162_L50_E50_sigma1";
