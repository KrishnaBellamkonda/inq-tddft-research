// ============================================================================
// run_classical_n162_L50_E700_knudsen/run.cpp — classical-electron projectile (custom
...
//
// Cfg: jellium::config::KnudsenSweep_L50_cubic_Classical_E700.
...
using Cfg = jellium::config::KnudsenSweep_L50_cubic_Classical_E700;
...
int main() {
    ...
    const std::string RUN_NAME = "run_classical_n162_L50_E700_knudsen";
