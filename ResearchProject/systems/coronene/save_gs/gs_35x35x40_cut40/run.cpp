// ============================================================================
// save_gs/gs_35x35x40_cut40/run.cpp
//
// Coronene GS at cell = 35 x 35 x 40 Bohr, cutoff 40 Ha.
// Loaded by run_35x35x40 (the smaller-box variant).
// ============================================================================
#include <inq/inq.hpp>
...
using Cfg = coronene::config::cell_35x35x40;
...
int main() {
    ...
    if (electrons.root()) {
        ...
        summary << "run = save_gs/gs_35x35x40_cut40\n"
