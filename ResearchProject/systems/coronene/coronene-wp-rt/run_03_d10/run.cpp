// coronene-wp-rt / run_03_d10: D=10A intermediate
#include <inq/inq.hpp>
...
static constexpr double D_ANG         = 10.0;
...
static constexpr double WP_EKIN_EV    = 200;
...
int main() {
    std::cout << "\n=== coronene run_03_d10: D=10A intermediate ===\n";
