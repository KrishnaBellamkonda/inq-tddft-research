// coronene-wp-rt / run_06_projectile: D=6.35A narrow high-E projectile
#include <inq/inq.hpp>
...
int main() {
    std::cout << "\n=== coronene run_06_projectile: D=6.35A narrow high-E projectile ===\n";
    ...
    auto electrons = systems::electrons(ions, options::electrons{}.cutoff(40.0_Ha).extra_states(3));
