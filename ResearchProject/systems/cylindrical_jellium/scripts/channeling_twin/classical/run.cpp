// ============================================================================
// cylindrical_jellium / scripts/channeling_twin / classical / run.cpp
//
// CLASSICAL HALF of the channeling twin: a rigid Gaussian CHARGE of std
// sigma_pot = sigma_WP/sqrt2 = 2.8284 Bohr, charge -1, mass m_e, launched
// on-axis at z = -28 with v = 1.917 a.u. (50 eV) down the hollow bore of the
// periodic r_s = 3 annular jellium tube, advanced by velocity-Verlet Ehrenfest
// from its own Hellmann-Feynman force.
//
...
int main(){
    ...
    std::cout << std::setprecision(12)
              << "\n=== channeling_twin/classical  OUT=" << OUT << " ===\n"
    ...
    if(electrons.root()){
        ...
        s << std::setprecision(14)
          << "run = cylindrical_jellium/channeling_twin/classical/" << env_s("CH_OUT","classical") << "\n"
