// ============================================================================
// localised_jellium_dynamics / proj_dyn / run.cpp   (Rung 2, classical twin)
//
// MOVING classical projectile = a rigid Gaussian charge advanced by EHRENFEST
// dynamics: each RT step we compute the Hellmann-Feynman force it feels from the
// (electrons − background) field, velocity-Verlet advance its position/velocity,
// and feed the new position to the moving perturbation for the next step. No
// prescribed path, no ghost UPF, no r_cut aliasing.
//
...
//      LJ_GS_DIR(REQUIRED) LJ_OUT(proj_dyn).
// ============================================================================
#include <inq/inq.hpp>
...
int main(){
    ...
    const std::string GS_DIR=env_s("LJ_GS_DIR",""), OUT="results/"+env_s("LJ_OUT","proj_dyn");
    ...
    std::cout<<std::setprecision(12)<<"\n=== proj_dyn OUT="<<OUT<<" z0="<<LAUNCH_Z<<" k0="<<K0
