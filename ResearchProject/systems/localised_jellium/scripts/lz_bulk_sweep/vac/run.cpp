// ============================================================================
// localised_jellium / scripts/lz_bulk_sweep / vac / run.cpp  (verbatim clone of sigma56_sv/vac)
//
...
int main() {
    ...
    if (electrons.root()) {
        ...
        s << std::setprecision(12)
          << "run = localised_jellium/lz_bulk_sweep/vac/" << env_s("WPC_OUT", CAP_ON?"cap":"nocap") << "\n"
