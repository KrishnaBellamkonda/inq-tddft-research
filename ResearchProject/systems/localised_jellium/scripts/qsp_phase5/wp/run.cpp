...
// z=-23.75, GS shared_gs/slab_n82_L50x50x90 reused) EXCEPT the drift momentum k0
...
int main() {
    ...
    const double CAP_ETA = -0.7, CAP_MID = 40.0/90.0, CAP_WIDTH = 10.0/90.0;  // two-sided, region [+/-35, +/-45]
    ...
    if (electrons.root()) {
        ...
        s << std::setprecision(12)
          << "run = localised_jellium/qsp_phase5/" << env_s("LJ_OUT","p5_wp") << "\n"
          << "engine = inq-study\n"
