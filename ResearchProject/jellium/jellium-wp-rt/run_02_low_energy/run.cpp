// ============================================================================
// jellium-wp-rt / run_02_low_energy: N=38 closed-shell jellium, 50 eV, σ=0.53 Å, +z
//
// Physical: L=40.0 bohr=21.18 Å; N_gs=38, r_s=7.38 a₀, n=5.94e-4 e/bohr³
// WP: σ=0.53 Å=1.00 bohr, k₀=1.917 bohr⁻¹, v=1.917 bohr/a.u.=41.8 Å/fs
// Loop-back: T_sim=16.68 a.u. / T_loop=20.87 a.u. = 80% → OK
// ============================================================================
...
static constexpr int    N_STEPS          = 834;  // half k₀ → twice the steps
...
int main() {
    std::cout << "\n=== jellium run_02_low_energy: N=38, 50 eV, σ=0.53 Å, +z ===\n";
