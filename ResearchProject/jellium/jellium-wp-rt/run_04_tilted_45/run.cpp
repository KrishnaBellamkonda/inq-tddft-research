// jellium-wp-rt / run_04_tilted_45: N=40 jellium, 200 eV, sigma=0.53A, 45-deg tilt
#include <inq/inq.hpp>
...
int main() {
    std::cout << "\n=== jellium run_04_tilted_45: N=40, 200 eV, 45-deg tilt ===\n";
    ...
    auto wp = inqkit::WavePacket{}.center(WP_CX, WP_CY, WP_CZ).sigma(WP_SIGMA_BOHR)
        .k0(WP_KX, 0.0, WP_KZ).orthogonalise_against_occupied(electrons);
