// ============================================================================
// jellium-wp-rt / run_04_tilted_45: N=38 closed-shell jellium, 200 eV, σ=0.53 Å, 45° xz
//
// Physical: L=40.0 bohr=21.18 Å; N_gs=38, r_s=7.38 a₀, n=5.94e-4 e/bohr³
// WP: σ=0.53 Å=1.00 bohr, |k₀|=3.834 bohr⁻¹, k_x=k_z=2.712 bohr⁻¹
// Loop-back: T_sim=7.00 a.u. / T_loop_z=14.76 a.u. = 47% → OK
// ============================================================================
...
// 45° tilt in xz-plane: k_x = k_z = k0/√2
static const double WP_KX = WP_K0 / std::sqrt(2.0);
static const double WP_KZ = WP_K0 / std::sqrt(2.0);
...
int main() {
    std::cout << "\n=== jellium run_04_tilted_45: N=38, 200 eV, 45° tilt in xz ===\n";
