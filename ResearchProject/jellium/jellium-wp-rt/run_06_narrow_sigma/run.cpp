// jellium-wp-rt / run_06_narrow_sigma: N=40 jellium, 200 eV, sigma=0.265A, +z
#include <inq/inq.hpp>
...
static constexpr int    N_STEPS     = 509;
...
int main() {
    std::cout << "\n=== jellium run_06_narrow_sigma: N=40, 200 eV, narrow sigma=0.265A ===\n";
