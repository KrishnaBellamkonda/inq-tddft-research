// ============================================================================
// jellium-wp-rt / run_03_high_energy: N=38 closed-shell jellium, 400 eV, σ=0.53 Å, +z
//
// Physical: L=40.0 bohr=21.18 Å; N_gs=38, r_s=7.38 a₀, n=5.94e-4 e/bohr³
// WP: σ=0.53 Å=1.00 bohr, k₀=5.422 bohr⁻¹, v=5.422 bohr/a.u.=118.2 Å/fs
// Loop-back: T_sim=5.90 a.u. / T_loop=7.38 a.u. = 80% → OK
// ============================================================================
...
int main() {
    std::cout << "\n=== jellium run_03_high_energy: N=38, 400 eV, σ=0.53 Å, +z ===\n";
