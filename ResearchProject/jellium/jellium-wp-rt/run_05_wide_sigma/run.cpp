// ============================================================================
// jellium-wp-rt / run_05_wide_sigma: N=38 closed-shell jellium, 200 eV, σ=2.0 Å, +z
//
// Physical: L=40.0 bohr=21.18 Å; N_gs=38, r_s=7.38 a₀, n=5.94e-4 e/bohr³
// WP: σ=2.0 Å=3.78 bohr, k₀=3.834 bohr⁻¹, v=3.834 bohr/a.u.=83.5 Å/fs
// Loop-back: T_sim=9.60 a.u. / T_loop=10.43 a.u. = 92% → OK (was 550 steps — fixed)
// ============================================================================
...
static const double WP_CZ = 5.0 * WP_SIGMA_BOHR;  // 18.90 bohr

static constexpr int    N_STEPS          = 480;  // was 550; reduced to prevent loop-back
...
int main() {
    std::cout << "\n=== jellium run_05_wide_sigma: N=38, 200 eV, σ=2.0 Å, +z ===\n";
