"""fig_density_profile_comparison_highdens — z-profile: jellium vs free WP.

Small multiples comparing n_WP(z,t) in jellium against free propagation.
Shows how the bath modifies the WP shape over time.

Run:
    python -m applications.report1.fig_density_profile_comparison_highdens
"""
...
RUN_JELL = Path("ResearchProject/systems/jellium/run_wp_n162_L30_E100_highdens_sigma1")
RUN_FREE = Path("ResearchProject/systems/jellium/run_free_wp_L30_E100_sigma1")
L_BOHR = 30.0
DT_JELL = 0.02
AU_TO_FS = 0.02418884

OUT = "docs/reports/report1/figures/fig_density_profile_comparison_highdens.png"
