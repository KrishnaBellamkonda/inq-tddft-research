"""fig_delta_density_comparison_highdens — Δn(jellium - free) small multiples.
...
Run:
    python -m applications.report1.fig_delta_density_comparison_highdens
"""
...
OUT = "docs/reports/report1/figures/fig_delta_density_comparison_highdens.png"
