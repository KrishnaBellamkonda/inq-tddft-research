"""fig08 — LEED waterfall across backscattering screens.

Radially-integrated LEED intensity as a 2D heatmap: (k_r, screen_z).
Uses screens 10-19 (z > 0 = backscattering side).

Run:
    python -m applications.report1.fig08_leed_waterfall_back
"""
...
def main() -> None:
    ...
    ax.text(0.97, 0.03, r"\textit{backscattering}",
    ...
    out = "docs/reports/report1/figures/fig08_leed_waterfall_back.png"
