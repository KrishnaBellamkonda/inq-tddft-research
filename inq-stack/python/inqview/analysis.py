"""
analysis.py — plotting functions for inqkit observables CSV output.

Each function accepts the path to an observables.csv produced by
inqkit::io::ObservablesWriter and returns a matplotlib Figure.
"""
...
def plot_observables_summary(
    ...
    **kwargs,
    ...
    Returns a Figure with up to 3 stacked subplots (panels are omitted if their
    columns are absent from the CSV).
    """
    df = load_observables(csv_path)
    defaults = DEFAULT_THEME.plot
