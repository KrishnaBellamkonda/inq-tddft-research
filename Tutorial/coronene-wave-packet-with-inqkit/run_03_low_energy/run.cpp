// ============================================================================
// run_03_low_energy: coronene + low-energy Gaussian wavepacket
//
// System: same cell and geometry as run_01.
//
// Wavepacket:
//   sigma = 0.53 Å = 1.002 bohr    (paper value)
//   E_kin = 50 eV → k0 = 1.917 bohr⁻¹   (4× less momentum than run_01)
//   center: cell centre in x,y; D = 6.35 Å above flake in z
//   direction: -z
//
// Purpose: compare injection diagnostics and density shape for lower momentum.
// ============================================================================
...
static constexpr double WP_EKIN_HA    = WP_EKIN_EV / HA_TO_EV;        // 1.838 Ha
static const     double WP_K0_BOHR    = std::sqrt(2.0 * WP_EKIN_HA);  // 1.917 bohr⁻¹
...
int main() {
    ...
    pf << "run              = run_03_low_energy\n";
    pf << "description      = Low-energy wavepacket: E_kin = 50 eV\n";
