// ============================================================================
// run_04_offcenter: coronene + off-center Gaussian wavepacket
//
// System: same cell and geometry as run_01.
//
// Wavepacket:
//   sigma = 0.53 Å = 1.002 bohr    (paper value)
//   E_kin = 200 eV → k0 = 3.834 bohr⁻¹
//   center: +3 Å in x from cell centre, D = 6.35 Å above flake in z
//   direction: -z
//
// Purpose: test symmetry-breaking injection; WP centre sits near outer C ring.
// ============================================================================
...
static constexpr double X_OFFSET_ANG  = 3.0;                           // 3 Å off-axis in x
static const     double WP_CX_BOHR    = LX_BOHR / 2.0 + X_OFFSET_ANG * ANG_TO_BOHR;
...
int main() {
    ...
    pf << "run              = run_04_offcenter\n";
    pf << "description      = Off-center wavepacket: +3 Ang offset in x\n";
