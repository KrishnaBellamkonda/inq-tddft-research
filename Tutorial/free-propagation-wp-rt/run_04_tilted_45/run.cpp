// run_04_tilted_45: free WP, 200 eV, sigma=0.53A, 45 deg in xz (kx=kz=-k0/sqrt(2))
#include <inq/inq.hpp>
...
// 45-degree tilt in xz: kx = kz = -k0/sqrt(2)
...
int main() {
    std::cout << "\n=== run_04_tilted_45: free WP, 200 eV, sigma=0.53A, 45-deg kx+kz ===\n";
    ...
    auto wp = inqkit::WavePacket{}.center(WP_CX, WP_CY, WP_CZ).sigma(WP_SIGMA_BOHR).k0(WP_KX, 0.0, WP_KZ);
